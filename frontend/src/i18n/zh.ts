...
export const zh: LocaleStrings = {
  ...
  reSplit: '重新分割',
  reTranslate: '重新翻译',
  editHint: 'Enter 换行 ／ Shift+Enter 在光标处分割（按字数比分配时间码） ／ Ctrl+Enter 保存 ／ Esc 取消',
  targetEditHint: 'Enter 换行 ／ Shift+Enter 在光标处分割（按字数比分配时间码） ／ Ctrl+Enter 保存 ／ Esc 取消',
  ...
  guide: [
    {
      ...
      paragraphs: [
        ...
        '注：WhisperX 转录流水线目前正在开发中。编辑器功能已正式可用。',
      ],
    },
    {
      title: '字幕块与CPS（字符/秒）',
      paragraphs: [
        ...
        '🟢 绿色（CPS ≤ 17）：阅读舒适  🟡 黄色（17〜25）：略快，建议确认  🔴 红色（> 25）：过快，建议分割',
        'CPS上限、每行最大字符数、最大行数等均可在设置标签页的"字幕质量参数"中调整。',
      ],
    },
    {
      title: '审批（锁定）机制',
  ...
  shortcuts: [
    {
      ...
      items: [
        ...
        { keys: ['Enter'], desc: '插入换行（每行最大字符数可在设置中调整）' },
  ...
  settingsMergeMinJaChars: '合并阈值最小日语字符数',
  settingsQualityCorrectionThreshold: '校正质量阈值（向量距离）',
  settingsQualityTranslationThreshold: '翻译质量阈值（向量距离）',
