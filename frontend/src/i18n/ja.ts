...
export const ja: LocaleStrings = {
  ...
  reSplit: '再分割',
  reTranslate: '再翻訳',
  editHint: 'Enter で改行 ／ Shift+Enter でカーソル位置で分割（文字数比でタイムコード自動割付） ／ Ctrl+Enter で保存 ／ Esc でキャンセル',
  targetEditHint: 'Enter で改行 ／ Shift+Enter でカーソル位置で分割（文字数比でタイムコード自動割付） ／ Ctrl+Enter で保存 ／ Esc でキャンセル',
  ...
  guide: [
    {
      ...
      paragraphs: [
        ...
        '注: WhisperX 書き起こし連携パイプラインは現在開発中です。エディタ機能は正式動作しています。',
      ],
    },
    {
      ...
      paragraphs: [
        ...
        '🟢 緑（CPS 17以下）: 読みやすい速度　🟡 黄（17〜25）: やや速い・要確認　🔴 赤（25超）: 速すぎる・分割を推奨',
        'CPS上限・1行の最大文字数・行数などは設定タブ「字幕品質パラメータ」で調整できます。',
      ],
    },
    {
      title: '承認（ロック）の仕組み',
  ...
  shortcuts: [
    {
      ...
      items: [
        ...
        { keys: ['Enter'], desc: '改行を挿入（1行の最大文字数は設定タブで変更可能）' },
