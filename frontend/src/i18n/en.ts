...
export const en: LocaleStrings = {
  ...
  editHint: 'Enter: newline ／ Shift+Enter: split here (timestamps by char ratio) ／ Ctrl+Enter: save ／ Esc: cancel',
  targetEditHint: 'Enter: newline ／ Shift+Enter: split here (timestamps by char ratio) ／ Ctrl+Enter: save ／ Esc: cancel',
  ...
  settingsEnMaxTotalChars: 'Max total chars (all lines)',
  settingsEnMaxCps: 'Max CPS (chars/sec)',
  settingsSubtitleMinDuration: 'Min display duration (sec)',
  settingsSubtitleMaxDuration: 'Max display duration (sec)',
  settingsMergeMinJaChars: 'Min JA chars to merge',
