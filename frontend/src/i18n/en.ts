...
export const en: LocaleStrings = {
  ...
  toast: {
    ...
    importProjectJson: 'Project JSON loaded',
    projectImportError: ({ error = '' }) => `Could not load project JSON: ${error}`,
    projectVersionTooNew: ({ found = '', supported = '' }) => `This project uses a newer format (v${found}; supported through v${supported})`,
    projectExportError: ({ error = '' }) => `Could not save project JSON: ${error}`,
    workLogWriteWarning: ({ error = '' }) => `The work log could not be written. The in-memory history will still be included in the project JSON: ${error}`,
  ...
  settingsPipelineMergeContinuationEnabled: 'Merge unfinished sentences with the next subtitle',
