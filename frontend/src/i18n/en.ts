...
export const en: LocaleStrings = {
  ...
  toast: {
    ...
    exportGlossaryLog: 'Glossary generation log exported',
    ...
    spellCheckFound: ({ count = 0 }) => `Spelling to review: ${count} (see red highlights in the Subtitles tab)`,
    spellWordAdded: ({ word = '' }) => `Added "${word}" to dictionary`,
    apiCompatibilityProfileDuplicated: 'API compatibility profile copied to User JSON',
    apiCompatibilityProfileDuplicateError: 'No API compatibility profile is available to copy',
    apiCompatibilityProfileExported: 'API compatibility profile JSON exported',
    apiCompatibilityProfileImported: 'API compatibility profile JSON imported',
    apiCompatibilityProfileInvalid: ({ error = '' }) => `API compatibility profile JSON is invalid. ${error}`,
  },

  videoPlayer: 'Video Player',
  tabSubtitles: 'Subtitle Edit',
  tabDictionary: 'Dictionary',
  tabHelp: 'Help',
  tabReport: 'Subtitle Generation',
  saving: 'Saving…',
  saved: '✓ Saved',
  loadProject: 'Load',
  saveProject: 'Save',
  ...
  srtFormatLabel: 'Format',
  srtFormatSource: 'Subtitle only',
  srtFormatTarget: 'Transcript only',
  srtFormatBoth: 'Both',
  srtFormatSelectTitle: 'Select SRT export format (subtitle / transcript / both)',
  ...
  guide: [
    {
      ...
      paragraphs: [
        ...
        'You can review run status, quality metrics, and failure-report details in the Subtitle Generation tab after dropping a video.',
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        'In the Dictionary tab, CSV/XLSX files can be imported by button or drag-and-drop. Drop video, SRT/JSON, and glossary files into their corresponding target areas.',
        'During import, the UI shows "Loading..." to prevent duplicate actions. Subtitle blocks show glossary highlights plus missing-term/typo/spelling candidates, and false positives can be ignored/restored (× / ↩).',
      ],
    },
  ],
  ...
  reportReviewQueue: 'Diagnostics: Review Candidates (Latest Run)',
